...
const LegacyStory = () => {
  return (
    <section className="bg-[#E8DBB3] py-40 px-6 md:px-20 text-[#0d2b1e]">
      <div className="max-w-7xl mx-auto flex flex-col xl:flex-row gap-20 items-start">
        
        {/* Left Content */}
        <div className="flex-1 space-y-12">
          <header>
            <h2 className="text-4xl md:text-5xl font-medium leading-tight text-[#0d2b1e]">
              A Legacy of <br /> Master Craftsmanship
            </h2>
          </header>

          <div className="space-y-8 text-[#0d2b1e]/80 font-light leading-relaxed text-sm md:text-base">
            <p>
            ...
            <p className="italic font-normal text-[#204a39] text-lg border-l border-[#204a39]/30 pl-6 py-2">
